                    ...
                    <div class="flex flex-col sm:flex-row justify-evenly space-y-2 sm:space-y-0">
                        ...
                        @for ($j = 0; $j < 4; $j++)
                            ...
                            @endphp
                                ...
                                <a class="text-center w-full  mt-4 bg-gradient-to-b from-blue-400 to-blue-600 bg-gradient-to-b  hover:from-orange-400 hover:to-orange-600 text-white py-2 text-xs md:text-sm xl:text-base rounded-lg" href="{{ route('registration.checkout.stripe.payment_recipient',['event_id' => $event_id,'payment_recipient' => $payment_recepients[$index]->id]) }}">Zaregistrovat se<br> a poslat 111Kč</a>
