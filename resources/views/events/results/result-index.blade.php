                        ...
                        <table id="result_table" class="hidden md:table table-auto border-collapse w-full mt-5">
                            ...
                            @foreach ($results as $result )
                                ...
                                <tr class="odd:bg-gray-100 even:bg-white" id="result_{{ $result->id }}">
                                    ...
                                    <td class="border px-2 text-center"><a class="test_tr" href="{{ route('result.map',$result->id) }}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4">
