...
<x-app-layout>
    <div class="smxxx:py-24 pb-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class=" sm:bg-white overflow-hidden shadow-sm sm:rounded-2xl mt-4 p-4  space-y-4">

                <div class="bg-gray-100 sm:bg-white overflow-hidden shadow-sm sm:rounded-xl">
                ...
                <div class="bg-gray-100 sm:bg-white overflow-hidden shadow-sm sm:rounded-xl">
                    <div class="w-full sm:rounded-xl text-white  text-xl sm:text-4xl text-center font-black bg-red-500 sm:bg-gray-600 py-2 sm:py-5 ">
                        Celý výtěžek jde na účet fundrasingové platformy Znesnáze21
                    </div>
                </div>
                ...
                <div class="sm:py-8 xl:py-4 md:px-4 flex flex-col sm:flex-row justify-between gap-x-4 gap-y-4 sm:bg-white overflow-hidden shadow-sm sm:rounded-2xl mt-4">
                    ...
                    <div class="w-full flex flex-col space-y-3 text-xl">





                        <div class="w-full  text-white text-center font-black bg-gray-600 rounded-xl p-3">

                            Plně automatizovaná možnost nahrávání běhů prostřednictvím STRAVA
                        ...
                        <div class="w-full  text-white text-center font-black bg-gray-600 rounded-xl p-3">
                            ...
                            Libovolný počet běhů na stejné trati a do výsledků se započítává nejlepší čas
