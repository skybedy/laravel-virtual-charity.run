    ...
    <div class="smxxx:py-24 pb-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="sm:py-8 xl:py-4 md:px-4 flex flex-col sm:flex-row justify-between gap-x-4 gap-y-4 sm:bg-white overflow-hidden shadow-sm sm:rounded-2xl mt-4">
                ...
                <a href="https://www.znesnaze21.cz" target="_blank" class="inline-block w-full sm:w-44 md:w-56 lg:w-[19rem] xl:w-96  sm:rounded-xl border border-gray-600 flex justify-center items-center">
            ...
            <div class=" sm:bg-white shadow-sm sm:rounded-2xl space-y-4 mt-4 p-4 text-white  text-xl sm:text-4xl text-center font-black">
            ...
            <ol class=" sm:bg-white shadow-sm sm:rounded-2xl space-y-4 p-4 text-white text-xl sm:text-4xl text-center font-black list-decimal list-inside mt-4">
                <div class="sm:rounded-xl  bg-gray-600 py-2 sm:py-5">
