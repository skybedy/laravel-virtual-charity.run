...
<x-app-layout>
    <div class="smxxx:py-24 pb-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-2 sm:py-4 md:px-4 flex flex-col sm:flex-row justify-between gap-x-4 gap-y-4 bg-white overflow-hidden shadow-sm rounded-xl sm:rounded-2xl mt-4">
                ...
                <a href="https://www.znesnaze21.cz" target="_blank" class="w-full sm:w-44 md:w-56 lg:w-[19rem] xl:w-96  sm:rounded-xl border border-gray-600 hidden sm:flex justify-center items-center">
...
>>>>>>> 69e5517 (Uprava vrchnich boxu)
            ...
            <div class="sm:bg-white shadow-sm sm:rounded-2xl space-y-1 sm:space-y-4 mt-4 sm:p-4 text-white text-xl sm:text-4xl text-center font-black">
                ...
                <div class="sm:rounded-xl font-black bg-gray-600 py-2 sm:py-5 px-1 sm:px-0">
