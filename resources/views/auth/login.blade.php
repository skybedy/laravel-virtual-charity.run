<x-guest-layout>
    ...
    <div class="flex justify-center mt-5 sm:mt-0 sm:items-center">
        <div class="display-inline sm:max-w-md my-2 md:mr-5  px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg border border-solid border-gray-200">
            ...
            <div class="mt-3"><a href="auth/facebook"><img class="img-fluid" src="images/facebook-login-icon.png" /></a></div>
            <div class="mt-3"><a href="auth/google"><img class="img-fluid" src="images/google-login-icon.png" /></a></div>
        </div>
    </div>
</x-guest-layout>
